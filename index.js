...
//connect to mongodb
const dbURI ='mongodb+srv://ascot233:Carter16@nodetuts.xztl7aj.mongodb.net/final?retryWrites=true&w=majority';
...
app.get('/home', requireAuth, (req, res) => res.render('hom'));
app.use(authRoutes);